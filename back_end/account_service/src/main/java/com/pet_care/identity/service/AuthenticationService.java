...
import com.pet_care.identity.dto.request.AuthenticationRequest;
import com.pet_care.identity.dto.request.IntrospectRequest;
import com.pet_care.identity.dto.request.LogoutRequest;
import com.pet_care.identity.dto.request.RefreshRequest;
...
import com.pet_care.identity.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        if (!authenticated || !Boolean.TRUE.equals(user.getIsActive())) {
    ...
    public void logout(LogoutRequest request) throws ParseException, JOSEException {
        try {
            ...
            InvalidedToken invalidedToken =
                    InvalidedToken.builder().id(jit).expiryTime(expiryTime).build();

            tokenRepository.save(invalidedToken);
        } catch (AppException e) {
            log.info("Token already expired, logout is a no-op");
        }
    }
