...
public enum ErrorCode {
    ...
    FIELD_REQUIRED(1014, "Required field is missing or blank", HttpStatus.BAD_REQUEST),
    TOO_MANY_REQUESTS(1015, "Too many requests, please try again later", HttpStatus.TOO_MANY_REQUESTS),
    ;
