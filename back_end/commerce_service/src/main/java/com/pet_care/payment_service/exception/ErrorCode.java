...
public enum ErrorCode {
    ...
    INVALID_PAYMENT_SIGNATURE(2007, "Invalid VNPay signature", HttpStatus.BAD_REQUEST),
    PAYMENT_AMOUNT_MISMATCH(2008, "Payment amount does not match transaction", HttpStatus.BAD_REQUEST),
