...
export const orderHistory = [
  ...
  { id: "ORD-002", date: "2026-03-28", status: "Processing", total: 215000, items: [{ name: "Anti-Flea Shampoo", qty: 1, price: 95000 }, { name: "Interactive Feather Toy", qty: 1, price: 65000 }, { name: "Vitamin C Supplement", qty: 0.5, price: 55000 }] },
  { id: "ORD-003", date: "2026-04-01", status: "Shipped", total: 450000, items: [{ name: "Cozy Pet Bed (Medium)", qty: 1, price: 450000 }] },
];

export const aiRecommendations = [
  { reason: "Based on your Golden Retriever", products: [1, 4, 10] },
];
