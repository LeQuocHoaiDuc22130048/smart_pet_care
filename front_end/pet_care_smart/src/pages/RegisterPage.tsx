...
import { Loader2, Lock, User as UserIcon, CalendarDays, CheckCircle2, ShieldCheck, Sparkles, ArrowRight } from 'lucide-react';
                ...
                <div className='my-auto space-y-8 z-10 max-w-lg'>
                    ...
                    >
                        <span className='inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/20 text-white border border-white/20 mb-4 backdrop-blur-sm'>
                            ...
                            Gia nhập cộng đồng PetCare hôm nay
                        </span>
                        <h1 className='text-4xl lg:text-5xl font-black tracking-tight leading-tight text-white drop-shadow-sm'>
                            ...
                            nhận <span className='text-yellow-200'>nhiều ưu đãi</span> đặc biệt.
                        </h1>
                        <p className='text-white/95 text-lg mt-4 leading-relaxed font-medium'>
                            Tạo tài khoản ngay hôm nay để nhận trọn vẹn đặc quyền ưu đãi dành cho người nuôi thú cưng thông thái.
                        </p>
                    </motion.div>

                    <div className='space-y-4 pt-2'>
                        {[
                            { icon: <CheckCircle2 className='w-5 h-5 text-yellow-300 shrink-0' />, text: 'Đặt lịch khám bệnh tại nhà nhanh chóng trong 30 giây.' },
                            { icon: <ShieldCheck className='w-5 h-5 text-yellow-300 shrink-0' />, text: 'Tích lũy điểm thưởng mua sắm không giới hạn.' },
                            { icon: <Sparkles className='w-5 h-5 text-yellow-300 shrink-0' />, text: 'Nhận các bài viết hướng dẫn chăm sóc chuyên biệt từ chuyên gia.' }
                        ].map((item, idx) => (
                            <motion.div
                                key={idx}
                ...
                <div className='z-10 bg-white/10 backdrop-blur-lg border border-white/15 p-5 rounded-2xl'>
                    <div className='grid grid-cols-2 gap-6 text-center divide-x divide-white/15'>
                        <div>
                            ...
                            <div className='text-xs text-white/80 mt-1 font-medium'>Bảo mật thông tin tuyệt đối</div>
                        </div>
                        <div>
                            <div className='text-3xl font-black text-white'>Miễn phí</div>
                            <div className='text-xs text-white/80 mt-1 font-medium'>Đăng ký & tư vấn trực tuyến</div>
                        </div>
                    </div>
                </div>
            </div>

            {/* Right Column - Elegant Register Card Form */}
                ...
                >
                    ...
                    <Card className='p-6 sm:p-8 rounded-3xl border border-border bg-card shadow-2xl dark:shadow-zinc-950/50 backdrop-blur-sm'>
                        <div className='text-left mb-6'>
                            <h1 className='text-3xl font-black text-foreground tracking-tight'>Đăng ký</h1>
